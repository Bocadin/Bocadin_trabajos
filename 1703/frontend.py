...
def ventana_login():
    ...
    def iniciar():
        ...
        if usuario_encontrado:
            ...
            messagebox.showerror("Login","El usuario no existe en la base de datos")
...
def ventana_Administrador():
    ...
    etiqueta6=tk.Label(ven3,text="Bienvenido Administrador")
    etiqueta6.pack(pady=10)

    boton5=tk.Button(ven3,text="Registrar usuarios", command=ventana_resgistrar)
    boton5.pack(pady=10)
    boton6=tk.Button(ven3,text="Opción 2")
    boton6.pack(pady=10)    
    boton7=tk.Button(ven3,text="Opción 3")
    boton7.pack(pady=10)
    boton8=tk.Button(ven3,text="Opción 4")
    boton8.pack(pady=10)
...
def ventana_Normal():
    ...
    etiqueta6=tk.Label(ven3,text="Bienvenido usuario normal")
    etiqueta6.pack(pady=10)

    boton5=tk.Button(ven3,text="Opción 1")
    boton5.pack(pady=10)
    boton6=tk.Button(ven3,text="Opción 2")
    boton6.pack(pady=10)    
    boton7=tk.Button(ven3,text="Opción 3")
