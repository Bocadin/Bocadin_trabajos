...
etiqueta1=tk.Label(ventana1,text="Selecciona tu lenguaje que sabes ocupar:")
etiqueta1.pack(pady=20)

python=tk.Checkbutton(ventana1,text="Python",variable=var1)
python.pack(padx=10, pady=20)

python=tk.Checkbutton(ventana1,text="Java",variable=var2)
python.pack(padx=10, pady=20)

python=tk.Checkbutton(ventana1,text="C++",variable=var3)
python.pack(padx=10, pady=20)
