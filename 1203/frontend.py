...
def ventana_login():
    ...
    ven2.protocol("WM_DELETE_WINDOW", al_cerrar)  
...
def ventana_admin():
    ven3=tk.Tk()
    ven3.title("Ventana administrador")
    ven3.geometry("500x500")
        
    etiqueta5=tk.Label(ven3, text="Ventana Admin", bg="Light blue", font="Arial")
    etiqueta5.pack(pady=10)
        
    boton5=tk.Button(ven3, text="Registrar usuario", command= ventana_principal())
    boton5.pack(pady=10)
    ven3.mainloop()
